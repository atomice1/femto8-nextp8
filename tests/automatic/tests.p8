...
function test_graphics()
    ...
    test_case("fillp_invert", function()cls()poke(0x5f34, 0x3)rectfill(1, 1, 10, 10, 0x184e.aaaa) check_eq(pget(1, 1), 0) check_eq(pget(2, 1), 0) check_eq(pget(0, 0), 4) check_eq(pget(0, 1), 4) check_eq(pget(11, 1), 0xe) end)
